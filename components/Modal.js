...
export default function Modal(props) {
    ...
    return ReactDom.createPortal(
        <div className='bg-slate-900 fixed inset-0 text-slate-900 text-lg sm:text-xl flex flex-col'>
            <div className='bg-slate-900 flex items-center justify-between border-b border-solid border-slate-900 p-4'>
                <h1 className='text-3xl select-none sm:text-6xl text-slate-200'>SPES CLUB</h1>
